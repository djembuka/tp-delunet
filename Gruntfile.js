module.exports = function( grunt ) {
  ...
  grunt.registerTask( 'js', [ 'concat:js', 'copy:devJSTemplate', 'copy:devJSComponents', /*'jshint:devTemplate', 'jshint:devComponents',*/ 'concat:pluginsJS', /*'uglify:devTemplate', 'uglify:devComponents',*/ 'clean:js' ] );
